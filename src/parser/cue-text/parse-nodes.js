import { CueTextTokenizer, TokenType } from './tokenizer.js';
...
class WebVTTNode {
  constructor(type, parent = null) {
    ...
    this.parent = parent;
    this.children = [];
    this.value = ''; // For text/timestamp/voice/lang/class
    this.classes = [];
    this.annotation = ''; // Raw annotation for voice/lang if needed
  }
 ...
 */
export function parseCueText(input) {
